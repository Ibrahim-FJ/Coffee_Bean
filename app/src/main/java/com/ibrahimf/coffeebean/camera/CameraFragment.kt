...
import com.ibrahimf.coffeebean.LumaListener
import com.ibrahimf.coffeebean.R
import com.ibrahimf.coffeebean.databinding.FragmentCameraBinding
...
class CameraFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.showPhoneImages?.setOnClickListener {
           findNavController().navigate(R.id.action_cameraFragment2_to_phoneImagesFragment)
        }
